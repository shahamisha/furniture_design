            ...
            <div className="justify-start items-center gap-[25px] inline-flex">
                ...
                <div className="relative">
                    <div className="w-[36.98px] h-[36.98px] left-0 top-0 absolute">
                        ...
                        <div className="w-[18.49px] h-[18.49px] left-[9.24px] top-[9.24px] absolute"></div>
                    </div>
                    <div className="left-[49.31px] top-[8.09px] absolute text-neutral-400 text-sm font-normal font-['Poppins']">Watch Video</div>
                </div>
            </div>
        </div>
